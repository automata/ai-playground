...
User: What are some books about the topic of love?
Assistant:
{
    "tools": [
        {
...

{
    "tools": [
        ...
        },
        {
            ...
            "result": [{"id": 1, "title": "Book 1", "authors": ["Author 1"]}, {"id": 2, "title": "Book 2", "authors": ["Author 2"]}]
        }
    ]
}
...
def tool_search_books(search_terms):
    search_query = " ".join(search_terms)
    url = "https://gutendex.com/books"
    response = requests.get(url, params={"search": search_terms})
    ...
    print("Search results:", simplified_results)
...
if __name__ == "__main__":
    ...
    for tool_call in tool_calls_json["tools"]:
        ...
        elif tool_call["tool_name"] == "search_books":
            result = tool_search_books(tool_call["parameters"]["query"])
            tool_calls_results[tool_call["tool_name"]] = result
